...
- Derived states doesn't need to be in useState
- When the state of the squares changes the component will re-render, causing
  the derived state to be updated and the component to reflect new managed state
  and derived state.
